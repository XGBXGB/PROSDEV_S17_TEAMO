					...
					<div class="nav-wrapper nav-container transparent grow">
						...
						<ul id="nav-mobile" class="right hide-on-med-and-down pad-nav-top">
							<li><a class="waves-effect waves-light btn compose-btn"
								href="new_post.html"><i class="material-icons compose-icon"
						...
						<ul class="side-nav teal" id="mobile-demo">
							...
							<li class="active"><a href="about_us.html"
								class="white-text">About Us</a></li>
				...
				<div class="row" style="margin-bottom: 0;">
					<div class="col s12 m12 l12">
						<div class="what-is-teamo">
							<span class="what-is">What is</span><span class="teamo-lbl"><br
								class="hide-on-med-and-up">TEAMO</span><span class="question-mark">?</span>
						</div>
						<div class="about-teamo">
							<span style="font-family: print clearly; font-size: 1.5em;">Teamo</span>
							is a blogging site which can help you post and express your ideas
							and interests with ease. <br>It's simple. <br>It's
							beautiful. <br>It's free.
						</div>
								...
								<div class="row" style="margin: 0">
									...
									<div class="col s12 member-wrapper">
										...
										<div class="col s9 m9 l9">
											<div class="name-wrapper valign-wrapper">
												<div>
													<div class="member-name2 left-align">Cheng, Jan
														Kristoffer</div>
													<div class="member-description-left">Developer.</div>
												</div>
											</div>
									...
									<div class="col s12 member-wrapper">
										<div class="col s9 m9 l9">
											<div class="name-wrapper valign-wrapper">
												<div style="width: 100%">
													<div class="member-name right-align">Cote, Christian
														Gabriel</div>
													<div class="member-description-right">Developer.</div>
												</div>
											</div>
									...
									<div class="col s12 member-wrapper">
										...
										<div class="col s9 m9 l9">
											<div class="name-wrapper valign-wrapper">
												<div>
													<div class="member-name2 left-align">Erive, Winona
														Louise</div>
													<div class="member-description-left">Developer.</div>
												</div>
											</div>
									...
									<div class="col s12 member-wrapper">
										<div class="col s9 m9 l9">
											<div class="name-wrapper valign-wrapper">
												<div style="width: 100%">
													<div class="member-name2 right-align">Lim, Ian
														Chesterson</div>
													<div class="member-description-right">Developer.</div>
												</div>
											</div>
									...
									<div class="col s12 member-wrapper">
										...
										<div class="col s9 m9 l9">
											<div class="name-wrapper valign-wrapper">
												<div>
													<div class="member-name2 left-align">Seo, Dong Seong
													</div>
													<div class="member-description-left">Developer.</div>
												</div>
											</div>
