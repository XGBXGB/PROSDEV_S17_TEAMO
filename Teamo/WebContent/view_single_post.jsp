          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              ...
              <h5 class = "white-text">COMMENTS</h3>
    			  ...
    			  {
                  %>
                  <p>"<%=comments.get(x).getComment() %>" by <%=comments.get(x).getUsername() %> on <%=comments.get(x).getDate() %></p>
                  <%} %>
            ...
            <div class="card-action">
                ...
                <input type = "text" placeholder = "place comment here" class = "white-text" name = "postcomment" id = "postcomment">
                <input type = "hidden" value = "<%=post.getPostId() %>" name = "postid" id = "postid">
                <input type = "Submit" class=" modal-action modal-close waves-effect waves-green btn white-text" id = "addcmnt" name = "addcmnt" value = "add Comment">
                </form>
